...
window.addEventListener('load', () => {
    ...
    const url = `https://api.openweathermap.org/data/2.5/weather?lat=-32.7912529&lon=-71.2084269&lang=es&units=metric&appid=527af813823205f3a60509919a23380c`
    fetch(url)
        ...
        .then(data => {
            ...
            ubicacion.textContent = 'La Calera'
